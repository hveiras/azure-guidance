...
[Data Consistency Primer](https://msdn.microsoft.com/en-us/library/dn589800.aspx) page on the Microsoft website.
...
> Both Azure Managed Cache Service and Azure In-Role Cache
  ...
  preparation for this retirement.
...
For more information visit the [ASP.NET Session State Provider for Azure Redis Cache](https://azure.microsoft.com/en-us/documentation/articles/cache-asp.net-session-state-provider/) page on [Azure.com](https://azure.microsoft.com).
...
- The [Azure Redis Cache](https://azure.microsoft.com/en-us/services/cache/) page on [Azure.com](https://azure.microsoft.com). 
- The [Which Azure Cache offering is right for me?](https://azure.microsoft.com/en-us/documentation/articles/cache-faq/#which-azure-cache-offering-is-right-for-me) page on [Azure.com](https://azure.microsoft.com).
...
- The [Running Redis on a CentOS Linux VM in Windows Azure](http://blogs.msdn.com/b/tconte/archive/2012/06/08/running-redis-on-a-centos-linux-vm-in-windows-azure.aspx) page on the Microsoft website.
- The [ASP.NET Session State Provider for Azure Redis Cache](https://azure.microsoft.com/en-us/documentation/articles/cache-asp.net-session-state-provider/) page on [Azure.com](https://azure.microsoft.com). 
- The [ASP.NET Output Cache Provider for Azure Redis Cache](https://azure.microsoft.com/en-us/documentation/articles/cache-asp.net-output-cache-provider/) page on [Azure.com](https://azure.microsoft.com).
- The [Azure Redis Cache Documentation](https://azure.microsoft.com/en-us/documentation/services/redis-cache/) page on [Azure.com](https://azure.microsoft.com).
